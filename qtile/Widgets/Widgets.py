    ...
    Screen(
        top=bar.Bar(
            [
                ...
                widget.TextBox("  ",fontsize=35,background=colores["aqua"],foreground=colores["red"],padding=-11,**powerline2),
                widget.TextBox("󰻠",fontsize=16,background=colores["red"],padding=10),
                widget.CPU(background=[colores["red"]]),
                widget.TextBox("  ",fontsize=35,background=colores["red"],foreground=colores["yellow"],padding=-11,**powerline2),
    ...
    Screen(
        top=bar.Bar(
            [
                ...
                widget.TextBox("󰻠",fontsize=16,background=colores["red"],padding=10),
                widget.CPU(background=[colores["red"]]),
                widget.TextBox(" ",fontsize=21,background=colores["red"],foreground=colores["yellow"],padding=1,**powerline2),
